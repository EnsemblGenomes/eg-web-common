...
sub content {
  ...
  my $polyploid_url    = $hub->url({'type' => 'Location', 'action' => 'MultiPolyploid'});
  ...
  return qq{
      ...
      <div class="navbar print_hide" style="width:$image_width">
        <a href="$polyploid_url"><img src="/i/48/region_thumb.png" title="Go to Region in Detail for more options" style="border:1px solid #ccc;margin:0 16px;vertical-align:middle" /></a> Go to <a href="$polyploid_url" class="no-visit">Polyploid view</a> 
      </div>
  };
}
