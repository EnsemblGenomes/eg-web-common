...
# $Id: GeneSNPImageSplice.pm,v 1.8 2011-11-18 16:53:33 jh15 Exp $

package EnsEMBL::Web::Component::Gene::GeneSNPImageSplice;
...
sub _content {
  ...
  my $master_config = $object->get_imageconfig($ic_type, 'transcript');
  ...
  foreach my $trans_obj (@sorted_trans) {
    ...
    $image_config->tree->dump("Transcript configuration", '([[caption]])')
