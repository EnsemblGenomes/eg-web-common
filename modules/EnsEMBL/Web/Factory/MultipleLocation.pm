...
sub best_guess {
  ...
  foreach my $method ($seq_region_name && $species eq $self->species ? 'LASTZ_PATCH' : (), qw(ATAC BLASTZ_NET LASTZ_NET TRANSLATED_BLAT TRANSLATED_BLAT_NET BLASTZ_RAW LASTZ_RAW BLASTZ_CHAIN)) {
