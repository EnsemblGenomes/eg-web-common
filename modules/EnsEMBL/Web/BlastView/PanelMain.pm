...
#----------------------------------------------------------------------
## ENA
## attempt to bypass the spaghetti mess of the rendering system
## and simply pass back the raw HTML from the html property
sub gen_raw_html {
  my $self  = shift;
  my $entry = shift;
  my $tmpl = q{
 <TR>
    <TD height=1 width=10 class="main_panel_bg" colspan=1><IMG src="/img/blank.gif" height=1 width=10 /></TD>
    <TD height=1 width=1 class="main_panel_border" colspan=1><IMG src="/img/blank.gif" height=1 width=1 /></TD>
    <TD height=1 width=10 class="main_panel_fg" colspan=1><IMG src="/img/blank.gif" height=1 width=10 /></TD>
    <TD height=1 width=5 class="main_panel_fg" colspan=1><IMG src="/img/blank.gif" height=1 width=5 /></TD>
    <TD height=1 width=5 class="main_panel_fg"  colspan=1><IMG src="/img/blank.gif" height=1 width=5 /></TD>
    <TD class="main_panel_fg" width='' valign="top" colspan=7>%s</TD>
    <TD height=1 width=5 class="main_panel_fg"  colspan=1><IMG src="/img/blank.gif" height=1 width=5 /></TD>
    <TD height=1 width=5 class="main_panel_fg" colspan=1><IMG src="/img/blank.gif" height=1 width=5 /></TD>
    <TD height=1 width=10 class="main_panel_fg" colspan=1><IMG src="/img/blank.gif" height=1 width=10 /></TD>
    <TD height=1 width=1 class="main_panel_border" colspan=1><IMG src="/img/blank.gif" height=1 width=1 /></TD>
  ...
  return sprintf( $tmpl, $entry->get_html );
}
...
sub gen_label_with_select{
  ...
  #return sprintf( $tmpl, 'label here', 'select here');
}
