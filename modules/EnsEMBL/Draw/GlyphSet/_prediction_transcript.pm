...
## EG
## This module is here to allow us to continue to use old GlyphSet_transcript
...
# force _transcript to use old GlyphSet_transcript
BEGIN {
  use EnsEMBL::Draw::GlyphSet_transcript;
  our @ISA = qw(EnsEMBL::Draw::GlyphSet_transcript);
}
