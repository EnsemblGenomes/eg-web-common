...
$Id: wublast_soaplite.pl,v 1.7 2013-12-19 09:34:19 nl2 Exp $
...
#my $WSDL = 'http://wwwdev.ebi.ac.uk/Tools/services/soap/wublast?wsdl'; # use dev version as EG data not yet in live
...
if ( $tool_params{'sensitivity'} eq 'custom' ){ undef $tool_params{'sensitivity'}; }
my %modeval = ('0.0001'=>'1e-4','0.001'=>'1e-3','0.01'=>'1e-2','0.1'=>'1e-1','1'=>'1.0');
$tool_params{'exp'} = $modeval{$tool_params{'exp'}} if defined $modeval{$tool_params{'exp'}};
