...
sub content {
  ...
  ## EG Start- Sent a pull request with the below line change[https://github.com/Ensembl/ensembl-webcode/pull/355]. Will need to remove this method once the pull request is merged.
